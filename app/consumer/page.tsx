...
export default function ConsumerPage() {
  ...
  useEffect(() => {
    ...
    // If user is authenticated but not a consumer, redirect to home
    if (session && session.user && session.user.role !== 'consumer') {
      router.replace('/');
    }
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-blue-100 text-lg mb-2">
            Welcome to your consumer portal
          </p>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-gray-600">
                    Access your consumer services and account information
                  </p>
                </div>
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-gray-800">Consumer</span>
                  </div>
                </div>
              </div>

              <div className="bg-green-50 rounded-lg p-4">
                <h3 className="font-semibold text-green-800 mb-2">Consumer Services</h3>
                <div className="space-y-2 text-sm">
                  <div className="flex items-center">
                    <div className="w-2 h-2 bg-green-500 rounded-full mr-2"></div>
                    <span className="text-green-700">Service Access</span>
                  </div>
                  <div className="flex items-center">
                    <div className="w-2 h-2 bg-blue-500 rounded-full mr-2"></div>
                    <span className="text-green-700">Account Management</span>
                  </div>
                  <div className="flex items-center">
                    <div className="w-2 h-2 bg-purple-500 rounded-full mr-2"></div>
                    <span className="text-green-700">Support Available</span>
                  </div>
                </div>
              </div>
            </div>
